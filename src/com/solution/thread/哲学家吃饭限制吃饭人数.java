 ...
 * 不加限制的情况下 运行一段时间就会死锁
 * 但是如果我们限制吃饭的人数最大为n-1 则同一时间 至少有一个人能够拿到两个筷子吃饭，则不会发生死锁
 * @author xiaoqiangli
 * @Date 2022-02-11
 */
@Slf4j
public class 哲学家吃饭限制吃饭人数 implements Runnable{
    ...
    private static Semaphore eats = new Semaphore(number - 1);  // 表示当前能吃饭的人数
    ...
    public static void main(String[] args) {
        for (int i = 0; i < number; i++) {
            new Thread(new 哲学家吃饭限制吃饭人数(i)).start();
        }
    }
}
